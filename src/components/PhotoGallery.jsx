...
export default function PhotoGallery({ photos }) {
	...
	const frameStyles = [
		'border-[12px] border-pink-200 rounded-lg rotate-2 shadow-xl',
		'border-[12px] border-purple-300 rounded-lg -rotate-3 shadow-xl',
		'border-[12px] border-yellow-100 rounded-lg rotate-1 shadow-xl',
		'border-[12px] border-purple-200 rounded-lg -rotate-2 shadow-xl',
		'border-[12px] border-yellow-100 rounded-lg rotate-3 shadow-xl',
